...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "dna_strands" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "empire_health_logs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"revenue_velocity" integer NOT NULL,
	"engagement_pulse" integer NOT NULL,
	"operational_consistency" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS "style_previews" (
	...
	"user_id" uuid NOT NULL,
	"niche" text NOT NULL,
	"dna_strand_ids" jsonb NOT NULL,
	"primary_vibe" text NOT NULL,
	"color_scheme" text NOT NULL,
	"typography_mood" text NOT NULL,
	"design_personality" text NOT NULL,
	...
	"difficulty" text DEFAULT 'instant' NOT NULL,
	"source_image_discarded" boolean DEFAULT true NOT NULL,
	"preview_generation_method" text NOT NULL,
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "user_settings" (
	...
	"currency" text DEFAULT 'USD' NOT NULL,
	"ai_mode" text DEFAULT 'co-pilot' NOT NULL,
	"auto_send_retention" boolean DEFAULT false NOT NULL,
	"onboarding_complete" boolean DEFAULT false NOT NULL,
	"linking_complete" boolean DEFAULT false NOT NULL,
	"notification_modal_dismissed" boolean DEFAULT false NOT NULL,
	"platform_permissions" jsonb,
	"connected_platforms" jsonb,
	"notification_settings" jsonb,
	"protocol_accepted" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "users" (
	...
	"tier" text DEFAULT 'STANDARD_USER' NOT NULL,
	"is_locked" boolean DEFAULT false NOT NULL,
	"password_hash" text,
	"access_key" text,
	"is_review_mode" boolean DEFAULT false NOT NULL,
	"mobile_session_token" text,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "empire_health_logs" ADD CONSTRAINT "empire_health_logs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "inbox_drafts" ADD CONSTRAINT "inbox_drafts_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "infrastructure_costs" ADD CONSTRAINT "infrastructure_costs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "oauth_sessions" ADD CONSTRAINT "oauth_sessions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "style_previews" ADD CONSTRAINT "style_previews_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
